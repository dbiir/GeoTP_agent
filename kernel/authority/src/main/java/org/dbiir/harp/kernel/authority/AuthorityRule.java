...
public final class AuthorityRule implements GlobalRule {
    ...
    public AuthorityRule(final AuthorityRuleConfiguration ruleConfig, final Map<String, AgentDatabase> databases) {
     ...
     */
    public String getAuthenticatorType(final AgentUser user) {
     ...
     * @return user
     */
    public Optional<AgentUser> findUser(final Grantee grantee) {
