...
package org.dbiir.harp.kernel.metadata.persist;

import lombok.Getter;
import org.dbiir.harp.kernel.metadata.persist.data.AgentDataPersistService;
import org.dbiir.harp.kernel.metadata.persist.service.DatabaseMetaDataPersistService;
import org.dbiir.harp.kernel.metadata.persist.service.MetaDataVersionPersistService;
import org.dbiir.harp.kernel.metadata.persist.service.config.database.DataSourcePersistService;
import org.dbiir.harp.kernel.metadata.persist.service.config.database.DatabaseRulePersistService;
import org.dbiir.harp.kernel.metadata.persist.service.config.global.GlobalRulePersistService;
import org.dbiir.harp.kernel.metadata.persist.service.config.global.PropertiesPersistService;
...
public final class MetaDataPersistService {
    ...
    private final AgentDataPersistService agentDataPersistService;
    ...
    public MetaDataPersistService(final PersistRepository repository) {
        ...
        agentDataPersistService = new AgentDataPersistService(repository);
    }
    ...
    public void persistConfigurations(final String databaseName, final DatabaseConfiguration databaseConfigs,
                                      final Map<String, DataSource> dataSources, final Collection<AgentRule> rules) {
