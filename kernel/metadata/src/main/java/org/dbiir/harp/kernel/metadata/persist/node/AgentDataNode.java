...
package org.dbiir.harp.kernel.metadata.persist.node;
...
public final class AgentDataNode {
    ...
    /**
     * Get Agent data node path.
     *
     * @return meta data node path
     */
    public static String getAgentDataNodePath() {
    ...
    public static String getDatabaseNamePath(final String databaseName) {
        return String.join("/", getAgentDataNodePath(), databaseName);
    }
    ...
    public static Optional<String> getDatabaseName(final String configNodeFullPath) {
        Pattern pattern = Pattern.compile(getAgentDataNodePath() + "/([\\w\\-]+)$", Pattern.CASE_INSENSITIVE);
    ...
    public static Optional<String> getSchemaName(final String configNodeFullPath) {
        Pattern pattern = Pattern.compile(getAgentDataNodePath() + "/([\\w\\-]+)/schemas/([\\w\\-]+)$", Pattern.CASE_INSENSITIVE);
        Matcher matcher = pattern.matcher(configNodeFullPath);
    ...
    public static Optional<String> getTableName(final String tableMetaDataPath) {
        Pattern pattern = Pattern.compile(getAgentDataNodePath() + "/([\\w\\-]+)/schemas/([\\w\\-]+)/tables" + "/([\\w\\-]+)$", Pattern.CASE_INSENSITIVE);
    ...
    public static Optional<String> getRowUniqueKey(final String rowPath) {
        Pattern pattern = Pattern.compile(getAgentDataNodePath() + "/([\\w\\-]+)/schemas/([\\w\\-]+)/tables" + "/([\\w\\-]+)" + "/(\\w+)$", Pattern.CASE_INSENSITIVE);
        Matcher matcher = pattern.matcher(rowPath);
