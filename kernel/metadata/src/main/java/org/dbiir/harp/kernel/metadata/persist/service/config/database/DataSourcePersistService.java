...
import org.dbiir.harp.utils.common.yaml.config.swapper.resource.YamlDataSourceConfigurationSwapper;
...
public final class DataSourcePersistService implements DatabaseBasedPersistService<Map<String, DataSourceProperties>> {
    ...
    public void persist(final String databaseName, final String version, final Map<String, DataSource> dataSources,
                        final Collection<AgentRule> rules, final Map<String, DataSourceProperties> dataSourcePropsMap) {
