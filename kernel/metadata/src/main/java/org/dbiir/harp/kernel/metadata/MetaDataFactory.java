...
package org.dbiir.harp.kernel.metadata;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import org.dbiir.harp.kernel.metadata.factory.ExternalMetaDataFactory;
import org.dbiir.harp.kernel.metadata.factory.InternalMetaDataFactory;
...
public final class MetaDataFactory {
     ...
     */
    public static AgentDatabase create(final String databaseName, final boolean internalLoadMetaData, final MetaDataPersistService persistService,
     ...
     * @throws SQLException sql exception
     */
    public static Map<String, AgentDatabase> create(final boolean internalLoadMetaData, final MetaDataPersistService persistService,
