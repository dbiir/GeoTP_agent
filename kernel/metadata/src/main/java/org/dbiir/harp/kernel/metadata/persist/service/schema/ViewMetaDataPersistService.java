...
import org.dbiir.harp.utils.common.yaml.schema.swapper.YamlViewSwapper;
...
public final class ViewMetaDataPersistService implements SchemaMetaDataPersistService<Map<String, AgentView>> {
    
    private final PersistRepository repository;
    
    @Override
    public void persist(final String databaseName, final String schemaName, final Map<String, AgentView> views) {
    ...
    @Override
    public Map<String, AgentView> load(final String databaseName, final String schemaName) {
    ...
    private Map<String, AgentView> getViewMetaDataByViewNames(final String databaseName, final String schemaName, final Collection<String> viewNames) {
        Map<String, AgentView> result = new LinkedHashMap<>(viewNames.size(), 1);
...
//                result.put(each.toLowerCase(), new YamlViewSwapper().swapToObject(YamlEngine.unmarshal(view, YamlAgnetView.class)));
//            }
        });
        return result;
    }
