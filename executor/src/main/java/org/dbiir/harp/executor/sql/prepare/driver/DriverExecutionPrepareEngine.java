...
package org.dbiir.harp.executor.sql.prepare.driver;
...
import org.dbiir.harp.executor.sql.execute.engine.driver.DriverExecutionUnit;
import org.dbiir.harp.executor.sql.prepare.AbstractExecutionPrepareEngine;
...
public final class DriverExecutionPrepareEngine<T extends DriverExecutionUnit<?>, C> extends AbstractExecutionPrepareEngine<T> {
    ...
    public DriverExecutionPrepareEngine(final String type, final int maxConnectionsSizePerQuery, final ExecutorConnectionManager<C> connectionManager,
                                        final ExecutorStatementManager<C, ?, ?> statementManager, final StorageResourceOption option, final Collection<AgentRule> rules,
