...
package org.dbiir.harp.executor.sql.hook;
...
public final class SPISQLExecutionHook implements SQLExecutionHook {
    ...
    private final Collection<SQLExecutionHook> sqlExecutionHooks = HarpServiceLoader.getServiceInstances(SQLExecutionHook.class);
