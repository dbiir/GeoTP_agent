...
package org.dbiir.harp.executor.kernel;
...
import org.dbiir.harp.executor.kernel.thread.ExecutorServiceManager;
...
public final class ExecutorEngine implements AutoCloseable {
    ...
    public <I, O> List<O> execute(final ExecutionGroupContext<I> executionGroupContext,
        ...
        List<O> result = serialExecute(executionGroupContext.getInputGroups().iterator(), firstCallback, callback);
