...
import org.dbiir.harp.merger.result.impl.stream.StreamMergedResult;
...
public class OrderByStreamMergedResult extends StreamMergedResult {
    ...
    public OrderByStreamMergedResult(final List<QueryResult> queryResults, final SelectStatementContext selectStatementContext, final AgentSchema schema) throws SQLException {
    ...
    private void orderResultSetsToQueue(final List<QueryResult> queryResults, final SelectStatementContext selectStatementContext, final AgentSchema schema) throws SQLException {
