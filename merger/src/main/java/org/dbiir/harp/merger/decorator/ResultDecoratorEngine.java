 ...
 */
public interface ResultDecoratorEngine<T extends AgentRule> extends ResultProcessEngine<T> {
     ...
     */
    ResultDecorator<?> newInstance(AgentDatabase database, T rule, ConfigurationProperties props, SQLStatementContext<?> sqlStatementContext);
}
