...
public final class ShowTableStatusMergedResult extends MemoryMergedResult {
    ...
    public ShowTableStatusMergedResult(final SQLStatementContext<?> sqlStatementContext,
                                       final AgentSchema schema, final List<QueryResult> queryResults) throws SQLException {
...
//                }
                assert (false); // not implement ShardingRule
            }
        }
