...
class H2JDBCRepositoryTest {
    ...
    void setUp() {
        Properties props = PropertiesBuilder.build(
                new PropertiesBuilder.Property("jdbc_url", "jdbc:h2:mem:config;DB_CLOSE_DELAY=-1;DATABASE_TO_UPPER=false;MODE=MYSQL"),
                new PropertiesBuilder.Property("username", "sa"),
                new PropertiesBuilder.Property("password", ""),
                new PropertiesBuilder.Property("provider", "H2"));
