...
import org.dbiir.harp.mode.standalone.repository.provider.MySQLJDBCRepositoryProvider;
...
class MySQLJDBCRepositoryProviderTest {
    ...
    void setUp() throws SQLException {
        ...
        repository.init(PropertiesBuilder.build(new PropertiesBuilder.Property("jdbc_url", "jdbc:mysql://localhost:3306/config"),
                new PropertiesBuilder.Property("username", "sa"), new PropertiesBuilder.Property("password", ""), new PropertiesBuilder.Property("provider", "MySQL")));
    }
