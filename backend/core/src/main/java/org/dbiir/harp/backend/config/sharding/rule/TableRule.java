...
import org.dbiir.harp.backend.config.sharding.exception.metadata.DataNodeGenerateException;
import org.dbiir.harp.backend.config.sharding.exception.metadata.DataNodesMissedWithShardingTableException;
...
import org.dbiir.harp.utils.common.datanode.DataNodeInfo;
import org.dbiir.harp.utils.common.datanode.DataNodeUtils;
...
//        keyGeneratorName = null;
    ...
    public TableRule(final ShardingTableRuleConfiguration tableRuleConfig, final Collection<String> dataSourceNames) {
        ...
        List<String> dataNodes = Collections.singletonList(tableRuleConfig.getActualDataNodes());
...
//        Preconditions.checkState(!isEmptyDataNodes(dataNodes) || null == tableShardingStrategyConfig || tableShardingStrategyConfig instanceof NoneShardingStrategyConfiguration,
