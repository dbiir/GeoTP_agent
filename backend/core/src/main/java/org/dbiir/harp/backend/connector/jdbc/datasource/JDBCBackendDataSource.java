...
package org.dbiir.harp.backend.connector.jdbc.datasource;

import com.google.common.base.Preconditions;

import org.dbiir.harp.backend.connector.BackendDataSource;
...
import org.dbiir.harp.utils.common.datasource.registry.GlobalDataSourceRegistry;
import org.dbiir.harp.utils.exceptions.OverallConnectionNotEnoughException;
...
public final class JDBCBackendDataSource implements BackendDataSource {
    ...
    private Connection createConnection(final String databaseName, final String dataSourceName, final DataSource dataSource, final TransactionType transactionType) throws SQLException {
        ...
        AgentTransactionManager transactionManager = transactionRule.getResource().getTransactionManager(transactionType);
    ...
    private boolean isInTransaction(final AgentTransactionManager transactionManager) {
