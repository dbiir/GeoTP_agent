...
package org.dbiir.harp.backend.util;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;

import org.dbiir.harp.backend.exception.FileIOException;
...
public final class ExportUtils {
     ...
     */
    public static String generateExportDatabaseData(final AgentDatabase database) {
    ...
    private static void appendDataSourceConfigurations(final AgentDatabase database, final StringBuilder stringBuilder) {
