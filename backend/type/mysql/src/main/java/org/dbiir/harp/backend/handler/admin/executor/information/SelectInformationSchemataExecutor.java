...
package org.dbiir.harp.backend.handler.admin.executor.information;
...
import org.dbiir.harp.backend.handler.admin.executor.AbstractDatabaseMetaDataExecutor;
import org.dbiir.harp.backend.handler.admin.executor.AbstractDatabaseMetaDataExecutor.DefaultDatabaseMetaDataExecutor;
...
public final class SelectInformationSchemataExecutor extends DefaultDatabaseMetaDataExecutor {
    ...
    protected void rowPostProcessing(final String databaseName, final Map<String, Object> rowMap, final Map<String, String> aliasMap) {
        AgentResourceMetaData resourceMetaData = ProxyContext.getInstance().getContextManager().getMetaDataContexts().getMetaData().getDatabase(databaseName).getResourceMetaData();
