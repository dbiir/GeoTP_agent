...
package org.dbiir.harp.db.protocol.packet.binlog.row;

import lombok.Getter;
import org.dbiir.harp.db.protocol.constant.MySQLBinlogEventType;
import org.dbiir.harp.db.protocol.packet.binlog.AbstractMySQLBinlogEventPacket;
import org.dbiir.harp.db.protocol.packet.binlog.MySQLBinlogEventHeader;
import org.dbiir.harp.db.protocol.packet.binlog.row.column.MySQLBinlogColumnDef;
import org.dbiir.harp.db.protocol.packet.binlog.row.column.value.MySQLBinlogProtocolValueFactory;
import org.dbiir.harp.db.protocol.packet.command.query.binary.execute.MySQLNullBitmap;
