...
package org.dbiir.harp.parser.rule.builder;
...
public final class SQLParserRuleBuilder implements GlobalRuleBuilder<SQLParserRuleConfiguration> {
    ...
    @Override
    public SQLParserRule build(final SQLParserRuleConfiguration ruleConfig, final Map<String, AgentDatabase> databases, final ConfigurationProperties props) {
