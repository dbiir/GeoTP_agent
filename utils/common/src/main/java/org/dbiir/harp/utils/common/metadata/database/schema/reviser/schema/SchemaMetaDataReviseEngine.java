...
package org.dbiir.harp.utils.common.metadata.database.schema.reviser.schema;
...
import org.dbiir.harp.utils.common.metadata.database.schema.loader.model.SchemaMetaData;
import org.dbiir.harp.utils.common.metadata.database.schema.loader.model.TableMetaData;
import org.dbiir.harp.utils.common.metadata.database.schema.reviser.MetaDataReviseEntry;
import org.dbiir.harp.utils.common.metadata.database.schema.reviser.table.TableMetaDataReviseEngine;
...
public final class SchemaMetaDataReviseEngine {
    ...
    public SchemaMetaData revise(final SchemaMetaData originalMetaData) {
        ...
        for (Entry<AgentRule, MetaDataReviseEntry> entry : OrderedSPILoader.getServices(MetaDataReviseEntry.class, rules).entrySet()) {
            result = revise(result, entry.getKey(), entry.getValue());
        }
        return result;
    }
    
    private <T extends AgentRule> SchemaMetaData revise(final SchemaMetaData originalMetaData, final T rule, final MetaDataReviseEntry<T> reviseEntry) {
