...
package org.dbiir.harp.utils.common.metadata.data;
 ...
 */
@Getter
public final class AgentDatabaseData {
    
    private final Map<String, AgentSchemaData> schemaData = new LinkedHashMap<>();
     ...
     */
    public AgentSchemaData getSchema(final String schemaName) {
     ...
     */
    public void putSchema(final String schemaName, final AgentSchemaData schema) {
