...
package org.dbiir.harp.utils.common.yaml.constructor;
 ...
 */
public class AgentYamlConstructor extends Constructor {
    ...
    public AgentYamlConstructor(final Class<?> rootClass) {
        ...
        HarpServiceLoader.getServiceInstances(AgentYamlConstruct.class).forEach(each -> typeConstructs.put(each.getType(), each));
