...
package org.dbiir.harp.utils.common.database.type;
...
import org.dbiir.harp.utils.exceptions.external.sql.type.wrapper.SQLWrapperException;
...
public final class DatabaseTypeEngine {
    ...
    public static DatabaseType getDatabaseType(final String url) {
        return HarpServiceLoader.getServiceInstances(DatabaseType.class).stream().filter(each -> matchURLs(url, each))
