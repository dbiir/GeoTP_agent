...
package org.dbiir.harp.utils.common.metadata;

import lombok.Getter;
import org.dbiir.harp.utils.common.config.props.ConfigurationProperties;
import org.dbiir.harp.utils.common.config.props.temporary.TemporaryConfigurationProperties;
...
public final class AgentMetaData {
    ...
    private final AgentRuleMetaData globalRuleMetaData;
    ...
    public AgentMetaData() {
        this(new LinkedHashMap<>(), new AgentRuleMetaData(Collections.emptyList()), new ConfigurationProperties(new Properties()));
    }

    public AgentMetaData(final Map<String, AgentDatabase> databases, final AgentRuleMetaData globalRuleMetaData, final ConfigurationProperties props) {
    ...
    public void addDatabase(final String databaseName, final DatabaseType protocolType) {
        AgentDatabase database = AgentDatabase.create(databaseName, protocolType);
     ...
     */
    public AgentDatabase getDatabase(final String databaseName) {
     ...
     */
    public void putDatabase(final AgentDatabase database) {
    ...
    public void dropDatabase(final String databaseName) {
        AgentDatabase toBeRemovedDatabase = databases.remove(databaseName.toLowerCase());
        closeResources(toBeRemovedDatabase);
    }

    private void closeResources(final AgentDatabase database) {
