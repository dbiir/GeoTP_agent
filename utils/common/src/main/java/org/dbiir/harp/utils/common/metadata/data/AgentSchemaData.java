 ...
 */
@Getter
public final class AgentSchemaData {
    
    private final Map<String, AgentTableData> tableData = new LinkedHashMap<>();
     ...
     */
    public AgentTableData getTable(final String tableName) {
     ...
     */
    public void putTable(final String tableName, final AgentTableData table) {
