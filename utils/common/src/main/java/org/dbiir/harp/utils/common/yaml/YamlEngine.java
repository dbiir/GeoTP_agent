...
package org.dbiir.harp.utils.common.yaml;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;

import org.dbiir.harp.utils.common.yaml.constructor.AgentYamlConstructor;
import org.dbiir.harp.utils.common.yaml.representer.AgentYamlRepresenter;
...
public final class YamlEngine {
    ...
    public static <T> T unmarshal(final String yamlContent, final Class<T> classType, final boolean skipMissingProps) {
        ...
        return new Yaml(new AgentYamlConstructor(classType), representer).loadAs(yamlContent, classType);
    }
    ...
    public static String marshal(final Object value) {
        ...
        if (value instanceof Collection) {
            return new Yaml(new AgentYamlRepresenter(), dumperOptions).dumpAs(value, null, DumperOptions.FlowStyle.BLOCK);
        }
        return new Yaml(new AgentYamlRepresenter(), dumperOptions).dumpAsMap(value);
    }
}
