...
package org.dbiir.harp.utils.common.yaml.representer;


import org.dbiir.harp.utils.common.spi.HarpServiceLoader;
import org.dbiir.harp.utils.common.yaml.representer.processor.AgentYamlTupleProcessor;
import org.dbiir.harp.utils.common.yaml.representer.processor.DefaultYamlTupleProcessor;
...
/**
 * Agent YAML representer.
 */
public final class AgentYamlRepresenter extends Representer {
    
    public AgentYamlRepresenter() {
        Map<String, Class<?>> yamlShortcuts = new HashMap<>();
        HarpServiceLoader.getServiceInstances(AgentYamlShortcuts.class).stream().map(AgentYamlShortcuts::getYamlShortcuts).forEach(yamlShortcuts::putAll);
    ...
    protected NodeTuple representJavaBeanProperty(final Object javaBean, final Property property, final Object propertyValue, final Tag customTag) {
        ...
        for (AgentYamlTupleProcessor each : HarpServiceLoader.getServiceInstances(AgentYamlTupleProcessor.class)) {
