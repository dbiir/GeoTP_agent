...
package org.dbiir.harp.utils.common.metadata.database.schema.pojo;
...
public final class AlterSchemaMetaDataPOJO {
    ...
    private final Collection<AgentTable> alteredTables = new LinkedList<>();
    
    private final Collection<AgentView> alteredViews = new LinkedList<>();
