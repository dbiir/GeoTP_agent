...
package org.dbiir.harp.utils.common.rule.identifier.type;
 ...
 */
public interface MutableDataNodeRule extends AgentRule {
     ...
     * @return single rule
     */
    AgentRule reloadRule(RuleConfiguration config, String databaseName, Map<String, DataSource> dataSourceMap, Collection<AgentRule> builtRules);
}
