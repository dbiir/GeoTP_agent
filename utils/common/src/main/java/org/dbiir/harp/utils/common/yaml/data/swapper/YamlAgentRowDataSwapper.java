...
import org.dbiir.harp.utils.common.metadata.data.AgentRowData;
...
/**
 * YAML Agent row data swapper.
 */
@RequiredArgsConstructor
public final class YamlAgentRowDataSwapper implements YamlConfigurationSwapper<YamlAgentRowData, AgentRowData> {
    
    private final List<AgentColumn> columns;
    
    @Override
    public YamlAgentRowData swapToYamlConfiguration(final AgentRowData data) {
        YamlAgentRowData result = new YamlAgentRowData();
