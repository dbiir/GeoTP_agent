...
package org.dbiir.harp.utils.common.config.props;

import lombok.Getter;
import lombok.RequiredArgsConstructor;
import org.dbiir.harp.utils.common.config.props.TypedPropertyKey;
...
public enum ConfigurationPropertyKey implements TypedPropertyKey {
    ...
    /**
     * Proxy coordinator default ip.
     */
    PROXY_COORDINATOR_DEFAULT_IP("coordinator-ip", "127.0.0.1", String.class, true),

    /**
     * Proxy coordinator default port.
     */
    PROXY_COORDINATOR_DEFAULT_PORT("coordinator-port", "3308", int.class, true),
