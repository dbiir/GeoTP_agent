 ...
 */
@Getter
public final class AgentSchema {
    
    private final Map<String, AgentTable> tables;
    
    private final Map<String, AgentView> views;
    ...
    public AgentSchema(final Map<String, AgentTable> tables, final Map<String, AgentView> views) {
     ...
     */
    public AgentTable getTable(final String tableName) {
     ...
     */
    public AgentView getView(final String viewName) {
     ...
     * @param table table
     */
    public void putTable(final String tableName, final AgentTable table) {
     ...
     * @param view view
     */
    public void putView(final String viewName, final AgentView view) {
     ...
     * @param tables tables
     */
    public void putAll(final Map<String, AgentTable> tables) {
        for (Entry<String, AgentTable> entry : tables.entrySet()) {
