...
public final class AgentData {
    ...
    private final Map<String, AgentDatabaseData> databaseData = new LinkedHashMap<>();
     ...
     */
    public AgentDatabaseData getDatabase(final String databaseName) {
     ...
     */
    public void putDatabase(final String databaseName, final AgentDatabaseData database) {
