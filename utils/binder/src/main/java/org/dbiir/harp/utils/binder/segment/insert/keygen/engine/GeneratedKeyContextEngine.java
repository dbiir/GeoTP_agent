...
package org.dbiir.harp.utils.binder.segment.insert.keygen.engine;
...
public final class GeneratedKeyContextEngine {
    ...
    private final AgentSchema schema;
    ...
    private Optional<String> findGenerateKeyColumn(final String tableName) {
        ...
        for (Entry<String, AgentColumn> entry : schema.getTable(tableName).getColumns().entrySet()) {
