...
package org.dbiir.harp.utils.binder.segment.table;
...
//    }
    ...
    public TablesContext(final Collection<? extends TableSegment> tableSegments, final DatabaseType databaseType) {
...
//    }
     ...
     */
    public Map<String, String> findTableNamesByColumnSegment(final Collection<ColumnSegment> columns, final AgentSchema schema) {
        if (1 == tables.size()) {
     ...
     * @return expression table name map
     */
    public Map<String, String> findTableNamesByColumnProjection(final Collection<ColumnProjection> columns, final AgentSchema schema) {
        if (1 == tables.size()) {
    ...
    private Map<String, String> findTableNameFromMetaData(final Collection<String> noOwnerColumnNames, final AgentSchema schema) {
